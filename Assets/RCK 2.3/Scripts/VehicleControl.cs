...
{
    private CustomSteeringWheel steeringWheelController;
    [SerializeField] private GameObject customSteeringWheel;
    ...
    void Awake()
    {
        steeringWheelController = customSteeringWheel.GetComponent<CustomSteeringWheel>();
    ...
    //{
    //    CustomSteeringWheel steeringWheelController = new steeringWheelController();
    //    steeringWheelController.StartSteeringWheel();
    //    steeringWheelController.StopSteeringWheel();
    ...
    void FixedUpdate()
    {
        ...
        if (activeControl)
        {
            ...
            //     accel = LogitechInput.GetAxis("Gas Vertical");
            //     brake  =  LogitechInput.GetAxis("Brake Vertical") > 32760f;
            ...
            //      if (accelFwd != 0.0f) { accel = accelFwd; } else { accel = accelBack; }
    ...
    private void UpdateCustomSteeringWheel()
    {
       // customSteeringWheel.transform.localRotation = Quaternion.Euler(15.535f, 0, -450 * LogitechInput.GetAxis("Steering Horizontal"));
    }
